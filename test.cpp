...
namespace test
{
	...
	public:
		...
		TEST_METHOD(mid_mid_mid) {
			Triangle T1(100, 100, 100);
			Assert::IsTrue(T1.getResult() == Result::Equilateral);
		...
		TEST_METHOD(min_mid_mid) {
			Triangle T1(1, 100, 100);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(mid_min_mid) {
			Triangle T1(100, 1, 100);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(mid_mid_min) {
			Triangle T1(100, 100, 1);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);
		...
		TEST_METHOD(max_mid_mid) {
			Triangle T1(200, 150, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_max_mid) {
			Triangle T1(150, 200, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_mid_max) {
			Triangle T1(150, 100, 200);
			Assert::IsTrue(T1.getResult() == Result::Scalene);
		...
		TEST_METHOD(minP_mid_mid) {
			Triangle T1(2, 150, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_minP_mid) {
			Triangle T1(150, 2, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_mid_minP) {
			Triangle T1(150, 100, 2);
			Assert::IsTrue(T1.getResult() == Result::Scalene);
		...
		TEST_METHOD(maxM_mid_mid) {
			Triangle T1(199, 150, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_maxM_mid) {
			Triangle T1(150, 199, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_mid_maxM) {
			Triangle T1(150, 100, 199);
			Assert::IsTrue(T1.getResult() == Result::Scalene);
	...
	TEST_CLASS(robustBoundary)
	{
	public:

		// maxP mid mid
		TEST_METHOD(maxP_mid_mid) {
			Triangle T1(201, 150, 150);
			Assert::IsTrue(T1.getResult() == Result::Error);

		}

		TEST_METHOD(mid_maxP_mid) {
			Triangle T1(150, 201, 150);
			Assert::IsTrue(T1.getResult() == Result::Error);

		}

		TEST_METHOD(mid_mid_maxP) {
			Triangle T1(150, 150, 201);
			Assert::IsTrue(T1.getResult() == Result::Error);
		...
		TEST_METHOD(minM_mid_mid) {
			Triangle T1(0, 150, 150);
			Assert::IsTrue(T1.getResult() == Result::Error);

		}

		TEST_METHOD(mid_minM_mid) {
			Triangle T1(150, 0, 150);
			Assert::IsTrue(T1.getResult() == Result::Error);

		}

		TEST_METHOD(mid_mid_minM) {
			Triangle T1(150, 150, 0);
			Assert::IsTrue(T1.getResult() == Result::Error);
	...
	TEST_CLASS(worstCaseBoundary)
	{
	public:

		// max max max
		TEST_METHOD(max_max_max) {
			Triangle T1(200, 200, 200);
			Assert::IsTrue(T1.getResult() == Result::Equilateral);
		...
		TEST_METHOD(max_max_mid) {
			Triangle T1(200, 200, 100);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(max_mid_max) {
			Triangle T1(200, 100, 200);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(mid_max_max) {
			Triangle T1(100, 200, 200);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);
		...
		TEST_METHOD(max_maxM_mid) {
			Triangle T1(200, 199, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(max_mid_maxM) {
			Triangle T1(200, 100, 199);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_max_maxM) {
			Triangle T1(100, 200, 199);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(mid_maxM_max) {
			Triangle T1(100, 199, 200);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(maxM_mid_max) {
			Triangle T1(199, 100, 200);
			Assert::IsTrue(T1.getResult() == Result::Scalene);

		}

		TEST_METHOD(maxM_max_mid) {
			Triangle T1(199, 200, 100);
			Assert::IsTrue(T1.getResult() == Result::Scalene);
		...
		TEST_METHOD(max_max_maxM) {
			Triangle T1(200, 200, 199);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(max_maxM_max) {
			Triangle T1(200, 199, 200);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(maxM_max_max) {
			Triangle T1(199, 200, 200);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);
		...
		TEST_METHOD(max_maxM_maxM) {
			Triangle T1(200, 199, 199);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(maxM_max_maxM) {
			Triangle T1(199, 200, 199);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(maxM_maxM_max) {
			Triangle T1(199, 199, 200);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);
		...
		TEST_METHOD(maxM_maxM_mid) {
			Triangle T1(199, 199, 100);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(maxM_mid_maxM) {
			Triangle T1(199, 100, 199);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);

		}

		TEST_METHOD(mid_maxM_maxM) {
			Triangle T1(100, 199, 199);
			Assert::IsTrue(T1.getResult() == Result::Isosceles);
